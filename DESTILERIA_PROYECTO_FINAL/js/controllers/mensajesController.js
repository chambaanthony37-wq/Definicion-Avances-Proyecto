...
export class MensajesController {
    constructor() {
        ...
        this.cargando = false;
        this.enviando = false;
        this.subscription = null; // para Realtime
    }
    ...
    init(onDataChange) {
        ...
        this.obtenerUsuarioActual().then(() => {
            this.cargar();
            this.suscribirMensajes(); // activar Realtime
        });
        ...
        // Carga periódica como respaldo (cada 30s)
        ...
        this.subscription = supabase
            ...
            .on(
                ...
                (payload) => {
                    ...
                    // Recargar mensajes y mostrar notificación
                    this.cargar();
                    mostrarToast(
    ...
    // Envío de alerta: SOLO para Jefe de Bodega (sin copia a Administrador)
    async enviarAlerta(titulo, mensaje, remitenteEmail) {
        ...
        try {
            ...
            // Verificar duplicados recientes (últimos 10 segundos) para Jefe de Bodega
            ...
            // Insertar mensaje para JEFE DE BODEGA (único destinatario)
            ...
            // Recargar mensajes si el usuario actual es Jefe de Bodega o Administrador
